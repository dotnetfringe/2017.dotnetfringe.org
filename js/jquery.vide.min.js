...
!function (a, b, c, d) {
    ...
    h.prototype.init = function () {
        ...
        d.$wrapper = a("<div>").css({
            ...
            d.$video.css("visibility", "visible"), d.resize(), d.$wrapper.css("background-image", "none")
    ...
    }, a[i] = {lookup: []}, a.fn[i] = function (b, c) {
        var d;
        ...
        a(b).bind("resize." + i, function () {
            for (var b, c = a[i].lookup.length, d = 0; c > d; d++)b = a[i].lookup[d], b && b.settings.resizing && b.resize()
