        ...
        return t.prototype = {
            defaults: {
                ...
                o = Array.prototype.slice.call(r.config.viewport.querySelectorAll("[data-sr]")), o.forEach(function (e) {
                    t = r.serial++, i = r.elems[t] = {domEl: e}, i.config = r.configFactory(i), i.styles = r.styleFactory(i), i.seen = !1, e.removeAttribute("data-sr"), e.setAttribute("style", i.styles.inline + i.styles.initial)
                ...
                var t = {}, i = {}, n = e.domEl.getAttribute("data-sr").split(/[, ]+/);
                ...
                var t = [], i = ["from", "the", "and", "then", "but", "with", "please"];
                ...
                var i = t.domEl.offsetHeight, o = r.getOffset(t.domEl).top, n = o + i, a = t.config.vFactor || 0;
